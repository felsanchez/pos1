...
<head>
  ...
  <!--PC--> <link rel="icon" href="vistas/img/plantilla/icono-negro.png">
...
<!-- Site wrapper -->
 <body class="hold-transition skin-blue sidebar-collapse sidebar-mini <?php if(!isset($_SESSION["iniciarSesion"]) || $_SESSION["iniciarSesion"] != "ok") echo 'login-page'; ?>">
...
<script src="vistas/js/historial-stock.js"></script>
<script src="vistas/js/estados-clientes.js"></script>
