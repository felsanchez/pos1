...
$(".tablaEstadosClientes").on("click", ".btnEditarEstado", function(){ 
...
$(".tablaEstadosClientes").on("click", ".btnEliminarEstado", function(){
	...
	swal({
		...
		if(result.value){
			...
			window.location = "index.php?ruta=estados-clientes&idEstado="+idEstado+"&nombreEstado="+nombreEstado;
		}
	}); 
