    ...
    <div class="box">
      ...
      <form role="form" method="post" enctype="multipart/form-data">
        ...
        <div class="box-body">
          ...
          <h4 class="text-primary"><i class="fa fa-credit-card"></i> Medios de Pago</h4> 
          ...
          <hr>
           ...
           <!-- Sección de Código de Producto -->

          <h4 class="text-primary"><i class="fa fa-barcode"></i> Configuración de Código de Producto</h4> 
          ...
          <h4 class="text-primary"><i class="fa fa-bell"></i> Alertas y Notificaciones</h4> 
          ...
          <!-- Sección de Alertas de Actividades y Gastos -->

          <h4 class="text-primary"><i class="fa fa-calendar"></i> Alertas de Actividades y Gastos</h4> 
          ...
          <!-- Sección de Alerta de Agente IA -->
          <h4 class="text-primary"><i class="fa fa-robot"></i> Alerta de Agente IA</h4>

          <div class="row">

            <!-- Alerta de Orden desde Agente IA -->
            <div class="col-md-12">
              <div class="form-group">
                <div class="checkbox">
                  <label style="font-weight: normal; cursor: pointer;">
          ...
          <!-- Sección de Colores de Factura -->

          <h4 class="text-primary"><i class="fa fa-paint-brush"></i> Colores de Factura</h4>
          ...
          <h4 class="text-primary"><i class="fa fa-shopping-cart"></i> Configuración de Ventas</h4>
          ...
          <!-- Sección de Configuración de Tickets -->
          <h4 class="text-primary"><i class="fa fa-print"></i> Configuración de Tickets</h4>
